//I added event handler for the file upload control to access the files properties.
        ...
        function ApplyFileValidationRules(readerEvt)
        {
            ...
            if (CheckFilesCount(AttachmentArray) == false) {
                if (!filesCounterAlertStatus) {
                    ...
                    alert("You have added more than 5 files. According to upload conditions you can upload 5 files maximum");
                }
                e.preventDefault();
                return;
            }
        ...
        function RenderThumbnail(e, readerEvt)
        {
            ...
            li.innerHTML = ['<div class="img-wrap"> <span class="close">&times;</span>' +
                '<img class="thumb" src="', e.target.result, '" title="', escape(readerEvt.name), '"/>' + '</div>'].join('');
